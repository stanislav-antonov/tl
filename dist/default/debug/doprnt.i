...
# 1 "C:/Program Files/Microchip/MPLABX/v5.45/packs/Microchip/PIC10-12Fxxx_DFP/1.3.46/xc8\\pic\\include\\__unsupported.h" 1 3
...
extern double atof(const char *);
extern double sin(double) __attribute__((unsupported("function \"" "sin" "\" is not supported by this device. Its minimum memory usage exceeds the maximum available")));;
extern double cos(double) __attribute__((unsupported("function \"" "cos" "\" is not supported by this device. Its minimum memory usage exceeds the maximum available")));;
extern double tan(double) __attribute__((unsupported("function \"" "tan" "\" is not supported by this device. Its minimum memory usage exceeds the maximum available")));;
extern double asin(double) __attribute__((unsupported("function \"" "asin" "\" is not supported by this device. Its minimum memory usage exceeds the maximum available")));;
extern double acos(double) __attribute__((unsupported("function \"" "acos" "\" is not supported by this device. Its minimum memory usage exceeds the maximum available")));;
extern double atan(double);
extern double atan2(double, double) __attribute__((unsupported("function \"" "atan2" "\" is not supported by this device. Its minimum memory usage exceeds the maximum available")));;
extern double log(double);
extern double log10(double);
extern double pow(double, double) __attribute__((unsupported("function \"" "pow" "\" is not supported by this device. Its minimum memory usage exceeds the maximum available")));;
extern double exp(double) __attribute__((unsupported("function \"" "exp" "\" is not supported by this device. Its minimum memory usage exceeds the maximum available")));;
extern double sinh(double) __attribute__((unsupported("function \"" "sinh" "\" is not supported by this device. Its minimum memory usage exceeds the maximum available")));;
extern double cosh(double) __attribute__((unsupported("function \"" "cosh" "\" is not supported by this device. Its minimum memory usage exceeds the maximum available")));;
